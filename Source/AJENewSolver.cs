...
namespace AJE
{
    public class AJENewSolver
    {
        ...
        //Compressor effects; pi_c is defined, tau_c is directly related to pi_c, eta_c is an efficiency used to relate pi_c to tau_c
        ...
        //The area sucked into the engine at the freestream, the area of the compressor inlet, area of the nozzle throat and the exit area of the engine
        ...
        public void InitializeComponentEfficiencies(double diffuserPresRatio, double compressorEfficiency, double burnerPresRatio, double turbineEfficiency, double nozzlePresRatio)
        {
            ...
            out double thrust, out double I_sp)
        {
            ...
            CalculateCompressorPropertiesFromTurbineEnergyBalance();
            ...
            //Effects of velocity difference at inlet and nozzle
            thrust = mdot * ((1 + f + f_ab) * U9 - U0);
            //Effects of pressure difference at inlet and nozzle
            thrust += (P9 - P0) * A9;
        ...
        public void CalculateCompressorPropertiesFromTurbineEnergyBalance()
        {
            tau_c = tau_t - 1;
        ...
        public void CalculateSuctionAreaForMassFlow()
        {
            ...
            A0 = A2 * astar_2_rat_a_2 / CalculateAreaRatioFromMachNumber(M0);
        }
        ...
        {
            M9 = CalculateMachNumberFromAreaRatioSupersonic(a_9_rat_astar_8_actual);
        ...
        public double CalculateAreaRatioFromMachNumber(double mach)
        {
            return 0;
        }

        public double CalculateMachNumberFromAreaRatioSupersonic(double areaRatio)
        {
            return 0;
        }

        public double CalculateMachNumberFromAreaRatioSubsonic(double areaRatio)
        {
            return 0;
        }
    }
